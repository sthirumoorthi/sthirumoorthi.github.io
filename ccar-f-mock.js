(() => {
  ...
  function renderResults() {
    ...
    const retake = () => { sessionStorage.removeItem(KEY); startAttempt(); window.scrollTo(0, 0); };
    $('.restart-button').addEventListener('click', retake); $('.result-retake-button').addEventListener('click', retake); renderReview();
  }
